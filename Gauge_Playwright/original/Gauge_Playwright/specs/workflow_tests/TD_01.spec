...
* Válaszd ki a "#BaseFilter" legördülő listából a "Szignálásra váró iratok" címkéjű elemet
...
TODO: concept
* Kattints a "Iratok" elemre
* Válaszd ki a "#BaseFilter" legördülő listából az "Iktatásra váró iratok" címkéjű elemet
* Írd a "CACHE:TD_iratazonosito" szöveget a "#FilingList_SearchPanel_CustomEditorName" címkével rendelkező elembe
* Nyomj egy Enter-t
* Várj "2" másodpercet
* Kattints a "#FilingList_DXMainTable" táblázat "2". sor "1". oszlopára
...
TODO: concept
* Kattints a "Iratok" elemre
* Válaszd ki a "#BaseFilter" legördülő listából a "Kiadmányozásra váró iratok" címkéjű elemet
* Írd a "CACHE:TD_iratazonosito" szöveget a "#FilingList_SearchPanel_CustomEditorName" címkével rendelkező elembe
* Nyomj egy Enter-t
* Kattints a "#FilingList_DXMainTable" táblázat "2". sor "1". oszlopára
...
TODO: concept
* Kattints a "Iratok" elemre
* Válaszd ki a "#BaseFilter" legördülő listából a "Expediálásra váró iratok" címkéjű elemet
* Írd a "CACHE:TD_iratazonosito" szöveget a "#FilingList_SearchPanel_CustomEditorName" címkével rendelkező elembe
* Nyomj egy Enter-t
* Várj "2" másodpercet
* Kattints a "#FilingList_DXMainTable" táblázat "2". sor "1". oszlopára
